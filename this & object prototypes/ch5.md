...
Как мы уже видели, механизм `[[Prototype]]` является внутренней ссылкой, существующей у объекта, которая ссылается на другой объект.
...
Помните, как в начале этой главы мы сказали, что `Object.create(..)` станет нашим героем? Теперь мы готовы увидеть, почему.
